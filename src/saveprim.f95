subroutine saveprim(t, rho, vex, vey, pre, rho0, pre0)
   use comvar
   implicit none
   ...
   write(10,*)'VARIABLES = "x", "y", "Density", "Velx", "Vely", "Pressure", "Mach" "drho", "dp"'
   ...
   do j=1,ny
      do i=1,nx
         ...
         m = q/a
         write(10,'(8E24.14)') x, y, rho(i,j), vex(i,j), vey(i,j), pre(i,j), m, &
              rho(i,j) - rho0(i,j), pre(i,j) - pre0(i,j)
